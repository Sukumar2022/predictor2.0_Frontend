...
const Home_banner4 = () => {
  return (
    <>
        ...
        <motion.h1 className='fun-font text-4xl w-100 font-bold text-center text-white mb-6 lg:w-200' initial={{y:200, opacity:0}} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay:0.6 }} viewport={{ once: true, amount: 0.5 }}>Ready to find the best E Shop for your product?</motion.h1>
